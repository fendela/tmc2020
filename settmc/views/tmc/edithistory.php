                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-12">
                                ...
                                if (count($history) == 0) {
                                     ...
                                     * 9 - Abpfiff
                                     */
                                    echo "<a class='btn btn-default' href='edithistory"
                                    . "?group={$_GET['group']}"
                                    . "&id_number={$_GET['id_number']}"
                                    . "&id_fixture={$_GET['id_fixture']}"
                                    . "&kickoff=7'>"
                                    ?>
                                    <span class="glyphicon glyphicon-play" aria-hidden="true"></span> Anstoss
                                    </a>
                                ...
                                <?php } else { ?>                                        
                                    ...
                                    <div class="row">
                                        ...
                                        . "&id_number={$_GET['id_number']}"
                                        . "&id_fixture={$_GET['id_fixture']}"
                                        . "&kickoff=9'><span class='glyphicon glyphicon-pause' aria-hidden='true'></span> Unterbrechnung</a>"
                                        ?>
                                        ...
                                        <div class="btn-group" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option9" autocomplete="off" value="9">
                                                <span class="glyphicon glyphicon-pause" aria-hidden="true"></span> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option1" autocomplete="off" value="1" checked> 
                                                <img src='../image/icons/tor.png' alt='Tor'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option2" autocomplete="off" value="2"> 
                                                <img src='../image/icons/et.png' alt='ET'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option3" autocomplete="off" value="3"> 
                                                <img src='../image/icons/2min.png' alt='2min'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option4" autocomplete="off" value="6"> 
                                                <img src='../image/icons/gk.png' alt='Gelb'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option5" autocomplete="off" value="4"> 
                                                <img src='../image/icons/grk.png' alt='GelbRot'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option6" autocomplete="off" value="5"> 
                                                <img src='../image/icons/rk.png' alt='Rot'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option7" autocomplete="off" value="10"> 
                                                <img src='../image/icons/eg.png' alt='Goal'> 
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="event" id="option8" autocomplete="off" value="11"> 
                                                <img src='../image/icons/ex.png' alt='Parade'> 
                                            </label>
                                            <!-- Pause Game -->
                                            <!--
                                            <label class="btn btn-default">

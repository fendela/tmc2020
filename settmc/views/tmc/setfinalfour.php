                    ...
                    <?php foreach ($schedule AS $row): ?>
                        ...
                        <tr>
                            ...
                            <td class='text-center'>
                                                ...
                                                <table>
                                                    ...
                                                    <?php foreach ($history[$row['id_number']] AS $rows): ?>
                                                        <tr>
                                                            ...
                                                            <td class='col-xs-10 text-left'><?php echo "{$rows["name"]} {$rows["surname"]}"; ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </table>
                                            </div>
                                ...
                                <?php
                                echo "<a class='btn btn-default btn-xs' href='edithistoryfinal?group={$group['id']}&id_fixture={$group['idFixture']}&id_number={$row['id_number']}&source=setfinalfour' role='button'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";
                                ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>

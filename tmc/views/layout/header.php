        ...
        <nav class="navbar navbar-inverse" style="
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index">Tackmann Cup</a>
                </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <?php foreach ($tournaments AS $row): ?>
                                    <li><a href="tournament?tournament=<?php echo $row["id"]; ?>"><?php echo $row["year"]; ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="tournament?tournament=<?php echo $thisTournament; ?>">&Uuml;bersicht</a></li>
